...
const (
	appName              = "franz-agent"
	defaultDataDirectory = ".franz-agent"
...
func (c *ProviderConfig) SetupOpenAICodex(accountID string) {
	...
	c.ExtraHeaders["originator"] = "franz-agent"
...
type Attribution struct {
	...
	GeneratedWith bool         `json:"generated_with,omitempty" jsonschema:"description=Add Generated with Franz line to commit messages and issues and PRs,default=true"`
}
...
type Options struct {
	...
	SkillsPaths               []string     `json:"skills_paths,omitempty" jsonschema:"description=Paths to directories containing Agent Skills (folders with SKILL.md files),example=~/.config/franz-agent/skills,example=./skills"`
	DisabledSkills            []string     `json:"disabled_skills,omitempty" jsonschema:"description=List of disabled skill names that should be excluded from runtime activation,example=my-skill"`
	Editor                    string       `json:"editor,omitempty" jsonschema:"description=Default external editor command used by the Open External Editor action,example=nvim,example=code --wait"`
	TUI                       *TUIOptions  `json:"tui,omitempty" jsonschema:"description=Terminal user interface options"`
	Debug                     bool         `json:"debug,omitempty" jsonschema:"description=Enable debug logging,default=false"`
	DebugLSP                  bool         `json:"debug_lsp,omitempty" jsonschema:"description=Enable debug logging for LSP servers,default=false"`
	DisableAutoSummarize      bool         `json:"disable_auto_summarize,omitempty" jsonschema:"description=Disable automatic conversation summarization,default=false"`
	DataDirectory             string       `json:"data_directory,omitempty" jsonschema:"description=Directory for storing application data (relative to working directory),default=.franz-agent,example=.franz-agent"` // Relative to the cwd
...
// Config holds the configuration for Franz.
type Config struct {
