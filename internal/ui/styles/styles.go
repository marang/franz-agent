...
func DefaultStyles() Styles {
	izooneGreen := color.RGBA{R: 0x15, G: 0x99, B: 0x47, A: 0xff}
	izooneGreenLight := color.RGBA{R: 0x1d, G: 0xd7, B: 0x65, A: 0xff}
	izooneNeonGreen := color.RGBA{R: 0x39, G: 0xff, B: 0x14, A: 0xff}
	izooneRedBlood := color.RGBA{R: 0xcd, G: 0x2d, B: 0x2d, A: 0xff}
	...
	s.TagInfo = s.TagBase.Background(blueLight).Foreground(charmtone.Pepper)
	s.TagWarn = s.TagBase.Background(lipgloss.Color("#8a5a1a"))

	// Compact header styles
	s.Header.Charm = base.Foreground(izooneGreenLight)
	s.Header.Diagonals = base.Foreground(izooneGreen)
	...
	// Agent task styles
	s.Tool.AgentTaskTag = base.Bold(true).Padding(0, 1).MarginLeft(2).Background(blueLight).Foreground(charmtone.Pepper)
	...
	// Buttons
	s.ButtonFocus = lipgloss.NewStyle().Foreground(charmtone.Pepper).Background(izooneGreenLight)
	...
	s.EditorPromptPlanIconFocused = lipgloss.NewStyle().MarginRight(1).Foreground(charmtone.Pepper).Background(izooneGreen).Bold(true).SetString(" P ")
	s.EditorPromptPlanIconBlurred = s.EditorPromptPlanIconFocused.Foreground(charmtone.Pepper).Background(charmtone.Squid)
	s.EditorPromptPlanDotsFocused = lipgloss.NewStyle().MarginRight(1).Foreground(izooneGreenLight).SetString(":::")
	...
	// Logo colors
	s.LogoFieldColor = izooneGreen
	s.LogoTitleColorA = izooneGreenLight
	s.LogoTitleColorB = izooneNeonGreen
	s.LogoCharmColor = izooneGreenLight
	s.LogoVersionColor = izooneRedBlood
	...
	s.Dialog.SelectedItem = base.Padding(0, 1).Background(blueLight).Foreground(charmtone.Pepper)
