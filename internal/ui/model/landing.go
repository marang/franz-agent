...
func (m *UI) landingView() string {
	...
	landingParts := layout.Vertical(layout.Len(lipgloss.Height(infoSection)+1), layout.Fill(1)).Split(m.layout.main)
	_, remainingHeightArea := landingParts[0], landingParts[1]
