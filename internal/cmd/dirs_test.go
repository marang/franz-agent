...
func init() {
	...
	os.Unsetenv("FRANZ_GLOBAL_CONFIG")
	os.Unsetenv("FRANZ_GLOBAL_DATA")
}
...
func TestDirs(t *testing.T) {
	...
	expected := filepath.FromSlash("/tmp/fakeconfig/franz-agent") + "\n" +
		filepath.FromSlash("/tmp/fakedata/franz-agent") + "\n"
...
func TestDataDir(t *testing.T) {
	...
	expected := filepath.FromSlash("/tmp/fakedata/franz-agent") + "\n"
	require.Equal(t, expected, b.String())
}
