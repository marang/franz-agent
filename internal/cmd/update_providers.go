...
franz-agent update-providers https://example.com/providers.json
...
franz-agent update-providers --source=hyper

# Update Hyper from a custom URL
franz-agent update-providers --source=hyper https://hyper.example.com
`,
