---
name: shell-builtins
description: Guide for adding and modifying shell builtin commands in Franz's embedded shell (internal/shell/). Use when creating a new builtin command, editing an existing one, or understanding how commands are intercepted in the mvdan/sh interpreter.
---

# Shell Builtins

Franz's shell (`internal/shell/`) uses `mvdan.cc/sh/v3` for POSIX shell
